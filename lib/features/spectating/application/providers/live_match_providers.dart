...
// ============ PARAMETER CLASSES ============
//
// Note: the live match stream providers below (watchLiveMatchSessionProvider,
// watchLiveBoardStateProvider, etc.) are keyed directly on the match id
// (`.family<T, String>`), matching how they're consumed in
// live_match_viewer_widget.dart. Dedicated per-provider param classes are
// intentionally not used for those simple single-id lookups.
