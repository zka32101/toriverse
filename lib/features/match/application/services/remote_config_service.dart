...
class RemoteConfigService {
  ...
  /// Default configuration values, used whenever Remote Config hasn't been
  /// initialized yet (or a fetch failed) — callers should never crash just
  /// because `initialize()` hasn't completed.
  ...
  int _getInt(String key) {
    ...
    if (remoteConfig == null) return _defaults[key] as int;
    try {
  ...
  String _getString(String key) {
    final remoteConfig = _remoteConfig;
    if (remoteConfig == null) return _defaults[key] as String;
    try {
  ...
  int getWeakBonusStoneDiffThreshold() {
    return _getInt('weak_bonus_stone_diff_threshold');
  }
  ...
  int getWeakBonusRoundThreshold() {
    return _getInt('weak_bonus_round_threshold');
  }
  ...
  int getWeakBonusMaxActivationsPerMatch() {
    return _getInt('weak_bonus_max_activations_per_match');
  }
  ...
  int getRescueCardConsecutiveAttacksThreshold() {
    return _getInt('rescue_card_consecutive_attacks');
  }
  ...
  int getSubmissionWindowTimeoutMs() {
    return _getInt('submission_window_timeout_ms');
  }
  ...
  int getDailyFreeRankMatches() {
    return _getInt('daily_free_rank_matches');
  }
  ...
  String getMinSupportedVersion() {
    return _getString('min_supported_version');
  }
